...
if (!projectName) {
  ...
  console.log(`${colors.dim}        npx github:crypto-priest/x402-solana-rust ${colors.bright}my-project${colors.reset}\n`);
  process.exit(1);
}
...
if (fs.existsSync(targetDir)) {
  console.error(`${colors.red}[ERROR]${colors.reset} Directory ${colors.bright}${projectName}${colors.reset} already exists\n`);
  process.exit(1);
}

console.log(logo);
console.log(`${colors.bright}${colors.blue}┌─────────────────────────────────────────────────────────────────────────────┐${colors.reset}`);
console.log(`${colors.bright}${colors.blue}│${colors.reset}  ${colors.bright}Framework Selection${colors.reset}                                                    ${colors.bright}${colors.blue}    │${colors.reset}`);
console.log(`${colors.bright}${colors.blue}└─────────────────────────────────────────────────────────────────────────────┘${colors.reset}\n`);
...
rl.question(frameworkPrompt, (answer) => {
  ...
  try {
    ...
    const cargoToml = cargoTemplate
      .replace('{{FRAMEWORK_DEPS}}', cargoPart)
    ...
    if (fs.existsSync(frontendSrcDir)) {
      ...
      try {
        ...
        console.warn(`${colors.dim}        cd ${projectName}/frontend && npm install && cp .env.example .env${colors.reset}\n`);
      }
    }
    ...
    console.log(`${colors.bright}${colors.blue}┌─────────────────────────────────────────────────────────────────────────────┐${colors.reset}`);
    console.log(`${colors.bright}${colors.blue}│${colors.reset}  ${colors.bright}Backend Setup${colors.reset}                                                          ${colors.bright}${colors.blue}    │${colors.reset}`);
    console.log(`${colors.bright}${colors.blue}└─────────────────────────────────────────────────────────────────────────────┘${colors.reset}\n`);
    ...
    console.log(`     ${colors.dim}$${colors.reset} ${colors.dim}# Edit .env and add your Solana receiver wallet address${colors.reset}\n`);
    ...
    console.log(`     ${colors.green}>>${colors.reset} Server will start on ${colors.bright}${colors.cyan}http://localhost:3000${colors.reset}\n`);

    console.log(`${colors.bright}${colors.blue}┌─────────────────────────────────────────────────────────────────────────────┐${colors.reset}`);
    console.log(`${colors.bright}${colors.blue}│${colors.reset}  ${colors.bright}Frontend Setup${colors.reset} ${colors.dim}(Dependencies Already Installed)${colors.reset}                      ${colors.bright}${colors.blue}      │${colors.reset}`);
    console.log(`${colors.bright}${colors.blue}└─────────────────────────────────────────────────────────────────────────────┘${colors.reset}\n`);
    ...
    console.log(`     ${colors.green}>>${colors.reset} Frontend will start on ${colors.bright}${colors.cyan}http://localhost:5173${colors.reset}\n`);
    ...
    console.log(`${colors.bright}${colors.blue}─────────────────────────────────────────────────────────────────────────────${colors.reset}\n`);
    console.log(`  ${colors.bright}Documentation:${colors.reset} ${colors.cyan}${projectName}/frontend/README.md${colors.reset}\n`);
